...
class sendip_info_to_portal:
    ...
    #CONNECTION_STRING = "HostName=yadavm-iothub-01.azure-devices.net;DeviceId=peabodytest2;SharedAccessKey=PoFWLugxUu3IicrsrXnE6qjgzMFBNhH1z07+uJcYRhA="
    ...
    def iothub_client_sample_run(self,message):
        try:
            ...
            if client.protocol == IoTHubTransportProvider.MQTT:
                ...
                client.send_reported_state(reported_state, len(reported_state), self.send_reported_state_callback, self.SEND_REPORTED_STATE_CONTEXT)
                status_counter = 0
